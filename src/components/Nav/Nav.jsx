        ...
        <nav className="nav">
            <ul className='nav__list'>
                <li className='nav__item'>
                    <NavLink onClick={()=>{top();}} className={({isActive}) => (isActive ? 'nav__item_link selected' : 'nav__item_link')} to='/'>Home</NavLink>
                </li>
                <li className='nav__item'>
                    <NavLink onClick={()=>{top();}}  className={({isActive}) => (isActive ? 'nav__item_link selected' : 'nav__item_link')} to='/about'>About</NavLink>
                </li>
                <li className='nav__item'>
