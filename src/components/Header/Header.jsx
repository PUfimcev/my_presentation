...
function Header(){
    ...
    function alterBurgerBtn() {
        ...
        setTimeout(()=>{setBurgerArrow(false); setShowBurgerBtn(false); setBurgerMenu(true);}, 1000);
        return;
    }
        ...
        <header className="header">
            <div className="container">
                <div className="header__content">
                    <Link onClick={top} className='header__main_title' to='/' title='main_page'>Pavel</Link>
